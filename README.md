HelloI chose to solve this problem by implementing a regex approach.Regex is made for solving this type of problem.
...
We can also go further and compare words to dictionaries such as websters and special medical dictionaries as well if needed. This will also helpwith misspellings words not separated with space, hyphens, and such.
...
enhancements down the road?I would definitely sort the output!multiple paragraph support?supported languages?translations?
